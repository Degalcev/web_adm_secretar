#!/usr/bin/env python3
"""Исправление nginx конфига на VPS."""
...
# Правильный конфиг для теста
TEST_NGINX = """# Тестовый сайт - catch-all для тестирования
server {
...
def main():
    ...
    try:
        ...
        run(ssh, 'apt install -y wget -qq')

        rc, out = run(ssh, 'wget -q -O- http://127.0.0.1/admin 2>&1 | head -5')
        print(f"Nginx response:\n{out}")
