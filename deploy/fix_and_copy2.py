#!/usr/bin/env python3
"""Исправление схемы и копирование данных."""
...
def main():
    ...
    try:
        print("[1/4] Увеличиваю organizers.name → varchar(100)...")
