#!/usr/bin/env python3
"""Копирование данных с UTF8 через connection string."""
...
# Подключение к test_db с client_encoding=UTF8
dst = psycopg2.connect(dbname="test_db", user="bot_secretar", password=",jnctrhtnfhm2024", host="localhost", client_encoding="UTF8")
