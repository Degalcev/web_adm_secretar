#!/usr/bin/env python3
"""Финальное копирование с set_client_encoding."""
...
# Устанавливаем UTF8 для подключения к test_db
...
print("\nDone!")
'''
        rc, out = run(ssh, f"cat > /tmp/cp3.py << 'EOF'\n{script}\nEOF")
        rc, out = run(ssh, "python3 /tmp/cp3.py")
        print(out)
